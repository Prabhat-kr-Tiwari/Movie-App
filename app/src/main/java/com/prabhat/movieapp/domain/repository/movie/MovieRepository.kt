...
interface MovieRepository {
    ...
    suspend fun getUpComingMovieDetailById(id: String): UpComingMovieDetailResponseDTO
    ...
    suspend fun getPopularSeriesDetailById(id:Int): PopularSeriesDetailResponseDTO
...
//    suspend fun getMovieByCategories(withGenre:String):Pager<Int,MovieByCategories>
    ...
    suspend fun getTvDetailById(id:Int,language: String): TvDetailResponseDTO
}